...
const ROOT = ".."; // le script tourne dans deck/, le dashboard est à la racine
...
const GROUPS = [
  { name: "🎤 Prépa orale", docs: [
    ...
    ["Script oral (à dire)", "deck/notes-orales-script.md"],
    ["Cue-cards (antisèche)", "deck/notes-orales-cue-cards.md"],
...
<body>
<div class="topbar">
  <div class="brand"><img src="deck/logo-greencity-mark.png" alt=""><div>GreenCity Tech<div class="sub">Oral · Liam Cariou · 24 août 2026</div></div></div>
  ...
  <a class="btn primary" href="deck/presentation.html" target="_blank">▶ Lancer la présentation</a>
  <a class="btn ghost" href="deck/GreenCityTech-LiamCariou.pdf" target="_blank">📄 PDF</a>
</div>
<div class="layout">
  <aside class="sidebar">
